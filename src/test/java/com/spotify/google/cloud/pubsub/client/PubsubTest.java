...
public class PubsubTest {
  ...
  public void testListTopics() throws Exception {
    ...
    final String expectedPath = baseUrl + "projects/" + PROJECT + "/topics";
  ...
  public void testListTopicsWithPageToken() throws Exception {
    ...
    final String expectedPath = baseUrl + "projects/" + PROJECT + "/topics?pageToken=" + pageToken;
  ...
  public void testGetTopic() throws Exception {
    ...
    final String expectedPath = baseUrl + "projects/" + PROJECT + "/topics/" + TOPIC_1;
  ...
  public void testCreateTopic() throws Exception {
    ...
    final String expectedPath = baseUrl + Topic.canonicalTopic(PROJECT, TOPIC_1);
  ...
  public void testListSubscriptions() throws Exception {
    ...
    final String expectedPath = baseUrl + "projects/" + PROJECT + "/subscriptions";
  ...
  public void testListSubscriptionsWithPageToken() throws Exception {
    ...
    final String expectedPath = baseUrl + "projects/" + PROJECT + "/subscriptions?pageToken=" + pageToken;
  ...
  public void testGetSubscription() throws Exception {
    ...
    final String expectedPath = baseUrl + "projects/" + PROJECT + "/subscriptions/" + SUBSCRIPTION_1;
  ...
  public void testCreateSubscription() throws Exception {
    ...
    final String expectedPath = baseUrl + Subscription.canonicalSubscription(PROJECT, SUBSCRIPTION_1);
  ...
  private void testPublish(final Message[] messages, final String[] ids)
    ...
    final String expectedPath = baseUrl + Topic.canonicalTopic(PROJECT, TOPIC_1) + ":publish";
  ...
  private void testPull(final ReceivedMessage... messages)
    ...
    final String expectedPath = baseUrl + Subscription.canonicalSubscription(PROJECT, SUBSCRIPTION_1) + ":pull";
  ...
  private void testAcknowledge(final String... ackIds)
    ...
    final String expectedPath =
        baseUrl + Subscription.canonicalSubscription(PROJECT, SUBSCRIPTION_1) + ":acknowledge";
  ...
  private void testModifyAckDeadline(final int ackDeadlineSeconds, final String... ackIds) throws Exception {
    ...
    final String expectedPath =
        baseUrl + Subscription.canonicalSubscription(PROJECT, SUBSCRIPTION_1) + ":modifyAckDeadline";
  ...
  public void testRequestFailure() throws Exception {
    ...
    assertThat(failure.statusMessage(), is("Internal Server Error"));
  }

  @Ignore("request timeouts not supported yet")
  @Test
  public void testPublishTimeoutFailureRecovery() throws Exception {
    ...
    server.enqueue(ok(PublishResponse.of("id1")));

    // Verify that a subsequent request is successful
    server.enqueue(ok(PublishResponse.of("id2")));
  ...
  private void assertRequestHeaders(final RecordedRequest request) {
    assertThat(request.getHeader(USER_AGENT), anyOf(is("Spotify Google-HTTP-Java-Client/1.20.0 (gzip)"),
                                                    is("Spotify-Google-Pubsub-Java-Client/2.0.0 (gzip)")));
  ...
  private static MockResponse ok(final Object response) {
    return response(200)
        .setBody(json(response));
  }

  private static MockResponse response(final int status) {
    return new MockResponse()
        .setStatus("HTTP/2 " + status);
  }
}
